            ...
            <div className="d-flex container justify-content-center align-items-center">
                <form className="form-group" onSubmit={(event) => this.handleSubmit(event)}>
                    ...
                    <div className="row mb-3">
                        ...
                        <div className="col-sm-10">
                            <input type="password" name="password" placeholder="Enter Password..." onChange={this.handleChange} value={this.state.password} /><br />
                        </div>
                    </div>
                    <div className="row mb-3">
                        <label>Email:</label>
                        <div className="col-sm-10">
                            <input type="email" name="email" placeholder="Enter Valid Email..." onChange={this.handleChange} value={this.state.email} /><br />
                        </div>
                    </div>
                    <div className="row mb-3">
